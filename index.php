	        		...
	        		<div class="box">
	        			<div class="box-header with-border">
	        				<div class="input-group">
				                <input type="text" class="form-control input-lg" id="searchBox" placeholder="Cari ISBN, Judul atau Penulis">
	        				...
	        				<table class="table table-bordered table-striped" id="booklist">
			        			...
			        			<?php
			        				...
			        				while($row = $query->fetch_assoc()){
			        					$status = ($row['status'] == 0) ? '<span class="label label-success">Tersedia</span>' : '<span class="label label-danger">Tidak Tersedia</span>';
			        					echo "
			        						<tr>
